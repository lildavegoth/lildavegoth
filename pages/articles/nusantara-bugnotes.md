...
![notification-not-disappear-nusan](images/notification-not-disappear-nusan.mp4)
- game space bug (rarely happens), double game space (kill game space to fix)
![gamespace-bug-nusan](images/gamespace-bug-nusan.webp)
...
![notif-reply-bug-nusan](images/notif-reply-bug-nusan.webp)
...
![lock-notif-bug-nusan](images/lock-notif-bug-nusan.webp)
- game space bug in portrait mode
![gamespace-bug-portrait-nusan](images/gamespace-bug-portrait-nusan.webp)
