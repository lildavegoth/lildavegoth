...
4. In **Developer Options**, enable **Enable Extension** option
5. Close or Relaunch Cromite app to load full Extensions system (**MUST FOLLOW THIS STEP**)

> **Install Extensions**
6. Go to Cromite Home and open [Chrome Web Extensions Store](https://chromewebstore.google.com)
7. Choose whatever **Extensions** you want and click **Add to Chrome** button to install
8. The popup will appear to confirm **Installations**, click **Add extension** and the Extension will be installed after the download is completed
9. If it's already installed, you'll see a new button on the right side of **Search Bar** and on left side of **Tabs**
10. To use the extension, open the **Extensions** button (between **Search Bar** and **Tabs**) then click your installed **Extension**. Since this feature still in development, some Extensions does not be able to be opened via Extensions button, but the actual Extensions are already running and works
