(function() {
    ...
    (function() {
        const isFirefoxAndroid = /Firefox|FxiOS/i.test(navigator.userAgent) && /Android/i.test(navigator.userAgent);
        ...
        if (isFirefoxAndroid) {
            ...
            document.addEventListener('DOMContentLoaded', function() {
                document.querySelectorAll('.blur-background, .bottom-nav, .more-bar, .popup-content, .project-card, .stat-card, .bio-card, .disclaimer-card, .tool-option, .credits-person, .search-suggestions').forEach(function(el) {
            ...
            const observer = new MutationObserver(function(mutations) {
                mutations.forEach(function(mutation) {
                    mutation.addedNodes.forEach(function(node) {
                        if (node.nodeType === 1) {
                            if (node.matches && node.matches('.blur-background, .bottom-nav, .more-bar, .popup-content, .project-card, .stat-card, .bio-card, .disclaimer-card, .tool-option, .credits-person, .search-suggestions')) {
                                node.style.backdropFilter = 'none';
                                node.style.webkitBackdropFilter = 'none';
                            }
                            if (node.querySelectorAll) {
                                node.querySelectorAll('.blur-background, .bottom-nav, .more-bar, .popup-content, .project-card, .stat-card, .bio-card, .disclaimer-card, .tool-option, .credits-person, .search-suggestions').forEach(function(child) {
