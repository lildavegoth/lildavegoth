...
5. Go back to Cromite home and open [Chrome Web Extensions Store](https://chromewebstore.google.com)
6. Choose whatever **Extensions** you want and click **Add to Chrome** button to install
7. The popup will appear to confirms **Installations**, click **Add extension** and the Extension will be installed after the download is completed
8. If it's already installed, you'll see a new button on the right side of **Search Bar** and on left side of **Tabs**
9. To use the extension, open the button between **Search Bar** and **Tabs** then click your installed **Extension**
